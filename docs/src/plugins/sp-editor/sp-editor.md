...
| 参数          | 类型    | 默认值                                         | 必填 | 说明                                                           |
| ------------- | ------- | ---------------------------------------------- | ---- | -------------------------------------------------------------- |
| editorId      | String  | editor                                         | 否   | 编辑器标签 id 属性，用于循环渲染编辑器时动态赋值，防止 id 重复 |
| placeholder   | String  | 写点什么吧 ~                                   | 否   | 编辑器占位字样                                                 |
| readOnly      | Boolean | false                                          | 否   | 是否只读                                                       |
| maxlength     | Number  | -1                                             | 否   | 最大字数限制，-1 不限                                          |
...
2. 截出来的图片模糊怎么办？
   ...
   - 简单示例：（此处为伪代码，具体建议前往 [`插件市场`](https://ext.dcloud.net.cn/plugin?id=14726) 导入示例项目以供参考）
